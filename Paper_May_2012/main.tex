...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
\todo{Wird die Webseite genannt? ist das sinnvoll dies zu tun?}
...
\todo{Ich wuerde localfunctional als volles Wort schreiben}
...
evaluate a functional \todocg{Ist hier was verrutscht? der Satz passt im
...
right hand side functional $l$.\todocg{Warum hier l und nicht f?}
\todo{Antwort: Weil $f$ die volumen kraft ist. Wir wollten 
doch Funktional und Kraftvektor unterscheiden. Daher hier $l$. Es gilt :
$l(\phi) = (f,\phi)$.}
