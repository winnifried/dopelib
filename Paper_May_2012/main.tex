...
%    }
% \end{lstlisting}
and it is done in a straight-forward way:\marginpar{Mir gefaellt dieses Auseinanderziehen nicht so wirklich...ist dieser zweite Abschnitt heir notwendig?}
\begin{lstlisting}
  for (/*all quadrature points per cell q*/)
   {
     ...
     for (/*all dofs per cell i*/)
      {
        Tensor<1,2> phi_i_u = ...;
        local_cell_vector(i) +=  scale * (u * phi_i_u) * 
                                  state_fe_values.JxW(q_point);    
      }
   }
\end{lstlisting}
