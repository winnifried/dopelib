...
The main difference, and common to all functionals is that as we only 
want to evaluate a functional, i.e., calculate a single number, and not a
residual-vector, i.e., calculate the elements of a vector. Thus, we 
