...
\begin{description}
\item[Discretization] Specify what kind of triangulation, time stepping
  scheme, finite element, quadrature rules, etc. we want to use.
...
the \deal{} \cite{deal} finite element library which has been developed
