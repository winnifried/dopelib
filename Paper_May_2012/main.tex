...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
\todo{Wird die Webseite genannt? ist das sinnvoll dies zu tun?}\todocg{Seite 2, vorletzter Absatz. Da wird DOpElib referenziert, und da steht dann auch die Webseite.}
...
\todocg{Ich habe den Rest auskommentiert. Mein Vorschlag waere: The main difference is that as we only want to evaluate a functional, i.e. a number, and not a residual-vector, we just loop over the quadrature points and not over the degrees of freedom on the face. }
