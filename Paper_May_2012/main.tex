...
\markboth{C. Goll et al.}{DOpElib: Differential Equations and Optimization Environment}
...
\category{G.4}{Mathematical Software}{Optimization routines and interface to finite element software}
\category{G.1.6}{Optimization}{Optimization with partial differential equations -- Constrained optimization}
\category{G.1.8}{Partial Differential Equations}{Finite element method}
%\todocg{ Siehe http://www.acm.org/about/class/1998/, ich komme damit aber nicht zurecht.}

\terms{Algorithms, Design, Documentation}

\keywords{goal oriented interface design, numerical solution of optimization problems and partial differential equations}

\acmformat{Goll, C.; Wick, G.; Wollner, W.; DOpElib: Differential Equations and Optimization Environment.}


\begin{bottomstuff}
Author's addresses: C. Goll, Institute of Applied Mathematics, 
              University of Heidelberg,
              Im Neuenheimer Feld 293/294, 69120 Heidelberg, Germany,  christian.goll@iwr.uni-heidelberg.de;   
...
Winnifried Wollner,  
              ...
              Bundesstr. 55, 20146 Hamburg, Germany,winnifried.wollner@math.uni-hamburg.de;   
\end{bottomstuff}
...
\begin{figure}[h]
\centering
{\includegraphics[trim = 50mm 50mm 50mm 50mm, clip, width=0.95\textwidth]{Pictures/local_grid_NSv2.png}}
...
\begin{figure}[hbt]
\centering
{\includegraphics[width=5.5cm]{Pictures/visit_fsi_2_CNn_t_2e-2_global_3_biharmonic_mesh8070_scale.png}}
{\includegraphics[width=5.5cm]{Pictures/visit_fsi_2_CNn_t_2e-2_global_3_biharmonic_x_velo8070_scale.png}}
...
\begin{figure}[hbt]
\centering
{\includegraphics[width=0.42\textwidth]{Pictures/ux_FSI_2_FS_t_3e-2_t_15e-3_global_2_Hron_grid.pdf}}
{\includegraphics[width=0.42\textwidth]{Pictures/uy_FSI_2_FS_t_3e-2_t_15e-3_global_2_Hron_grid.pdf}}
{\includegraphics[width=0.42\textwidth]{Pictures/Drag_fluid_FSI_2_FS_t_3e-2_t_15e-3_global_2_Hron_grid.pdf}}
{\includegraphics[width=0.42\textwidth]{Pictures/Lift_fluid_FSI_2_FS_t_3e-2_t_15e-3_global_2_Hron_grid.pdf}}
