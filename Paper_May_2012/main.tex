...
file the user might specifiy material paramters for the concrete PDE, but also
...
\end{lstlisting}
After explaining the basic compononents that are necessary (and always the same in DOpElib) 
