...
\institute{Christian Goll \at
              ...
              %Tel.: +49 622-154-6154\\
              \email{christian.goll@iwr.uni-heidelberg.de}           %  \\
           \and
Thomas Wick \at
...
\begin{figure}[hbt]
\centering
{\includegraphics[width=0.85\textwidth]{Pictures/local_grid_NS.png}}
...
\begin{figure}[hbt]
\centering
\resizebox{0.45\textwidth}{!}{\input{Pictures/ConvergenceNS}}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth, viewport=205 88 975 500, clip]{Pictures/MBB.png}
...
To obtain thickness values that are either $1$ or $0$, so that we can
interpreter the results in terms of material or no material, we apply the 
so called SIMP-model (Solid Isotropic Material with Penalization) 
with parameter $p = 4$ 
to obtain the distribution given in Fig.~\ref{res:mbb-top}.

\begin{figure}
\centering
\includegraphics[width=0.75\textwidth, viewport=205 88 975 500, clip]{Pictures/MBB-top.png}
\caption{Thickness distribution for the MBB-beam minimum compliance topology optimization problem.} 
\label{res:mbb-top}
\end{figure}
