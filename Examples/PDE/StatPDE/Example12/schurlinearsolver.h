...
//If dealii version 9.0.0 or later, the iterative_inverse.h file is replaced
...
#else //Older deal.II than 9.0.0 uses iterative_inverse for the solver 
#include <deal.II/lac/vector.h>
#include <deal.II/lac/block_sparsity_pattern.h>
#include <deal.II/lac/block_sparse_matrix.h>
...
#endif //Older Deal.II versions than 9.0.0 end
#endif
