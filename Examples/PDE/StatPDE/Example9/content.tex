...
In this example we consider a simple stationary FSI problem. \index{stationary PDE} \index{stationary PDE!FSI problem} The fluid
is given as an incompressible Newtonian fluid modelled by the Stokes equation. Here, we use the symmetric stress tensor which has a little consequence when using the do-nothing outflow condition, see also section \ref{PDE_Stat_Stokes}. \index{fluid} \index{fluid!incompressible} \index{fluid!Newtonian}
