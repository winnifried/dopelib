...
typedef PDEProblemContainer<LocalPDE<VECTOR, 2>,DirichletDataInterface<VECTOR,2>,SPARSITYPATTERN, VECTOR,2> OP;
...
//  dealii::GridGenerator::hyper_cube(times);
  ...
  MethodOfLines_StateSpaceTimeHandler<FE, DOFHANDLER, SPARSITYPATTERN, VECTOR,
      SparsityMaker<DOFHANDLER, 2> , ConstraintsMaker<DOFHANDLER, 2> , 2> DOFH(
