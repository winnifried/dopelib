...
is given as an incompressible Newtonian fluid modelled by the Stokes equation. Here, we use the symmetric stress tensor which has a little consequence when using the do-nothing outflow condition. \index{fluid} \index{fluid!incompressible} \index{fluid!Newtonian}
