...
// Define block issues
typedef TrilinosWrappers::BlockSparseMatrix MATRIXBLOCK;
typedef TrilinosWrappers::BlockSparsityPattern SPARSITYPATTERNBLOCK;
typedef TrilinosWrappers::MPI::BlockVector VECTORBLOCK;
...
typedef DOpEWrapper::PreconditionIdentity_Wrapper<MATRIXBLOCK>
    PRECONDITIONERIDENTITYBLOCK;
typedef DOpEWrapper::PreconditionIdentity_Wrapper<MATRIX>
    PRECONDITIONERIDENTITY;
typedef DOpEWrapper::PreconditionIdentity_Wrapper<MATRIX>
    PRECONDITIONERSSOR; // TODO !!!
...
typedef PDEProblemContainer<LocalPDE<CDC, FDC, DOFHANDLER, VECTORBLOCK, DIM>,
                            ...
                            SPARSITYPATTERNBLOCK, VECTORBLOCK, DIM>
    OPBLOCK;
...
typedef GMRESLinearSolverWithMatrix<
    PRECONDITIONERIDENTITYBLOCK, SPARSITYPATTERNBLOCK, MATRIXBLOCK, VECTORBLOCK>
    GMRESIDENTITYBLOCK;
...
typedef MethodOfLines_StateSpaceTimeHandler<
    FE, DOFHANDLER, SPARSITYPATTERNBLOCK, VECTORBLOCK, DIM>
    STHBLOCK;
