...
typedef DirectLinearSolverWithMatrix<BlockSparsityPattern,
				     ...
				     BlockVector<double>,LOCALDEALDIM> LINEARSOLVER;

typedef InstatStepNewtonSolver<INTEGRATOR,LINEARSOLVER,BlockVector<double>,LOCALDEALDIM> NLS;
...
int main(int argc, char **argv)
{
  ...
  LocalBoundaryFunctionalDrag<VECTOR, LOCALDOPEDIM,LOCALDEALDIM>::declare_params(pr);
  LocalBoundaryFunctionalLift<VECTOR, LOCALDOPEDIM,LOCALDEALDIM>::declare_params(pr);
