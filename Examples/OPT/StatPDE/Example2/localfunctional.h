	...
	for(unsigned int q_point = 0; q_point< n_q_points; q_point++)
	{
	  _fvalues[q_point](0) = ( sin(M_PI * state_fe_values.quadrature_point(q_point)(0)) *
				   (sin(M_PI * state_fe_values.quadrature_point(q_point)(1)) +
				    0.5*sin(2 * M_PI * state_fe_values.quadrature_point(q_point)(1))));
	  _fvalues[q_point](1) = ( sin(2*M_PI * state_fe_values.quadrature_point(q_point)(0)) *
	  ...
	  r += 0.5* (_uvalues[q_point](1)-_fvalues[q_point](1))*(_uvalues[q_point](1)-_fvalues[q_point](1))
	    * state_fe_values.JxW(q_point);
	  r+= _alpha*0.5*(_qvalues(0)*_qvalues(0)+_qvalues(1)*_qvalues(1)+_qvalues(2)*_qvalues(2))* state_fe_values.JxW(q_point);
	}
