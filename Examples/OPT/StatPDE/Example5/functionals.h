...
template<template<int, int> class DH,typename VECTOR, int dopedim, int dealdim>
  class QErrorFunctional : public FunctionalInterface<Multimesh_CellDataContainer,Multimesh_FaceDataContainer,DH, VECTOR,dopedim,dealdim>
  {
  public:
    QErrorFunctional()
    {
...
template<template<int, int> class DH, typename VECTOR, int dopedim, int dealdim>
  class UErrorFunctional : public FunctionalInterface<Multimesh_CellDataContainer,Multimesh_FaceDataContainer,DH, VECTOR,dopedim,dealdim>
  {
  public:
    UErrorFunctional()
    {
...
/****************************************************************************************/template<template<int, int> class DH, typename VECTOR, int dopedim, int dealdim>
  class LocalMeanValueFunctional : public FunctionalInterface<Multimesh_CellDataContainer,Multimesh_FaceDataContainer,DH, VECTOR,dopedim,dealdim>
  {
  public:
...
template<template<int, int> class DH, typename VECTOR, int dopedim, int dealdim>
  class LocalPointFunctional : public FunctionalInterface<Multimesh_CellDataContainer,Multimesh_FaceDataContainer,DH, VECTOR, dopedim,dealdim>
  {
  public:
