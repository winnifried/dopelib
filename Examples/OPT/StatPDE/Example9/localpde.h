...
//
 ...
 {  
    ...
    void CellEquation_UU(const CellDataContainer<DH, VECTOR, dealdim>& cdc,
			 dealii::Vector<double> &local_cell_vector, double scale, double /*scale_ico*/)
    {
      const DOpEWrapper::FEValues<dealdim> & state_fe_values = cdc.GetFEValuesState();
      unsigned int n_dofs_per_cell = cdc.GetNDoFsPerCell();
  ...
  void BoundaryEquation_Q (const FaceDataContainer<DH, VECTOR, dealdim>& fdc,
 ...
 void BoundaryEquation_QT (const FaceDataContainer<DH, VECTOR, dealdim>& fdc,
			   dealii::Vector<double> &local_cell_vector,
			   double scale, double /*scale_ico*/)
  {
    const auto & state_fe_face_values = fdc.GetFEFaceValuesState();
 ...
 void BoundaryEquation_QTT (const FaceDataContainer<DH, VECTOR, dealdim>& fdc,
			    dealii::Vector<double> &local_cell_vector,
			    double scale, double /*scale_ico*/)
 {  
   const auto & state_fe_face_values = fdc.GetFEFaceValuesState();
 ...
 void BoundaryEquation_U (const FaceDataContainer<DH, VECTOR, dealdim>& fdc,
			  dealii::Vector<double> &local_cell_vector, double scale, double /*scale_ico*/)
 {
   const auto & state_fe_face_values = fdc.GetFEFaceValuesState();
   unsigned int n_dofs_per_cell = fdc.GetNDoFsPerCell();
  ...
  void BoundaryEquation_UT (const FaceDataContainer<DH, VECTOR, dealdim>& fdc,
			   dealii::Vector<double> &local_cell_vector,
			   double scale, double /*scale_ico*/)
  {
    const auto & state_fe_face_values = fdc.GetFEFaceValuesState();
 ...
 void BoundaryEquation_UTT (const FaceDataContainer<DH, VECTOR, dealdim>& fdc,
			    dealii::Vector<double> &local_cell_vector,
			    double scale, double /*scale_ico*/)
  {
     const auto & state_fe_face_values = fdc.GetFEFaceValuesState();
...
///// Hier FaceEquation einfuegen
  ...
  void FaceEquation (const FaceDataContainer<DH, VECTOR, dealdim>& ,
			 dealii::Vector<double> &, double, double)
  {

  }
  void FaceMatrix (const FaceDataContainer<DH, VECTOR, dealdim>& ,
		       dealii::FullMatrix<double> &, double, double )
  {
  }
  void FaceRightHandSide (const FaceDataContainer<DH, VECTOR, dealdim>&,
			      dealii::Vector<double> &, double)
  {
    assert(this->_problem_type == "state");
  }
 
  void FaceEquation_Q (const FaceDataContainer<DH, VECTOR, dealdim>& ,
			   dealii::Vector<double> &,
			   double, double)
  {
  }

 void FaceEquation_QT (const FaceDataContainer<DH, VECTOR, dealdim>&,
			   dealii::Vector<double> &,
			   double, double)
 {
}

 void FaceEquation_QTT (const FaceDataContainer<DH, VECTOR, dealdim>&,
			    dealii::Vector<double> &,
			    double, double)
 { 
 }

 void FaceEquation_U (const FaceDataContainer<DH, VECTOR, dealdim>&,
			  dealii::Vector<double> &, double, double)
 {
 }

  void FaceEquation_UT (const FaceDataContainer<DH, VECTOR, dealdim>&,
			   dealii::Vector<double> &,
			   double, double)
  {
  }

 void FaceEquation_UTT (const FaceDataContainer<DH, VECTOR, dealdim>&,
			    dealii::Vector<double> &,
			    double, double)
  {
  }
