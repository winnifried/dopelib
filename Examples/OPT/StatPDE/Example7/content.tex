...
Another new feature is the use of the commercial optimization library SNOPT. 
...
To use this algorithm you need to have SNOPT installed! \\To use this set the WITH\underline{ }SNOP CompilerFlag.} 