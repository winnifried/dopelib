...
\todo[inline]{Brauchen wir den n\"achsten Block wirklich? Das steht 1 Seite dar\"uber schon, 
die Notation passt aber nicht immer, z.B. $J''(u)$, fehlende Argumente und Funktionen (z.N. Dual Hessian Equation)
. 
Ansonsten müssen wir den Block nochmal durchgehen um die Sachen zu beheben.}
...
Especially, the equations for stationary optimization problems are
given as follows:
...
\end{align*}
\todo[inline]{end of delete comment}
...
We have
\todo[inline]{Wollen wir die alle? Die Terme $a'_u$ sind ja alle Gleich bis auf das 
jeweilige argument...}
\begin{align*}
a(q,u)(\phi) &= (\nabla u, \nabla\phi) - (q + f, \phi),\\
a_u'(q,u)(\phi, z) &= (\nabla\phi, \nabla z),\\
