...
\item \texttt{reducedproblems/ipopt\underline{ }problem.h} A wrapper file that is used by the 
  reduced\underline{ }ipopt\underline{ }algorithm when solving optimization problems. This file
...
\begin{itemize}
  ...
  \item \texttt{wrapper/solutiontransfer\underliner{ }wrapper.h} A wrapper for the SolutionTransfer class
    from \texttt{deal.II}. 
