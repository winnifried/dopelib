...
\added{There are two ways to obtain a copy of \dope{}:\\
%
\begin{enumerate}[A)]
...
maintainer by sending an EMail to \url{dope@dopelib.net}.
%
...
I) Get a copy of \texttt{DOpElib}, see Section~\ref{sec:obtain} for details.
%
