...
Detailed installing instructions for deal.II can be found on\\ 
\texttt{http://www.dealii.org/}. 

In deal.II 8 and newer a configuration of deal.II working with \texttt{DOpElib} can be done with
...
mkdir install
cd build
cmake -DCMAKE_INSTALL_PREFIX=../install -DDEAL_II_WITH_UMFPACK=true -DDEAL_II_FORCE_BUNDLED_UMFPACK=true  ../
make install
\end{lstlisting}
