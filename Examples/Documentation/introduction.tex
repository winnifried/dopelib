...
\subsection*{4.) Different g++ compilers are used for compiling DOpElib and the Examples folder}
{\footnotesize
\begin{lstlisting}
...
\end{lstlisting}
where path/to/compiler should be the path to the compiler, DOpElib was compiled with.
...
/usr/lib64/gcc/x86_64-suse-linux/4.8/../../../../x86_64-suse-linux/bin/ld: cannot find -lmpi_usempi
/usr/lib64/gcc/x86_64-suse-linux/4.8/../../../../x86_64-suse-linux/bin/ld: cannot find -lmpi_mpifh
/usr/lib64/gcc/x86_64-suse-linux/4.8/../../../../x86_64-suse-linux/bin/ld: cannot find -lmpi
collect2: error: ld returned 1 exit status
\end{lstlisting}
}

An alternative to the previous solution is:
\begin{lstlisting}
export DEAL_II_DIR =your_mpi_deal_II_version // only necessary 
      // when not in the standard path
export PATH=/usr/lib64/mpi/gcc/openmpi/bin:${PATH}  // obtain your MPI path
      // with `whereis mpicxx' etc.
...
Or include the export lines into the 
\begin{lstlisting}
.bash_rc 
\end{lstlisting}
or 
