...
for the use of MPI use 

\begin{lstlisting}
-DDEAL_II_WITH_MPI=true
\end{lstlisting}

and for the use of distributed meshes over several computers the p4est
library is needed in deal.II to use this use the flags (in addition to the use of MPI)
\begin{lstlisting}
-DDEAL_II_WITH_P4EST=true -DP4EST_DIR=[path to p4est]
\end{lstlisting}
...
modified in some illegal way. Remove this Makefile and get the original 
one from DOpElib. Then try again make c-all (make always sure that before 
