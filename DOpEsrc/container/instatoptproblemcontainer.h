...
namespace DOpE
{
  ...
  class InstatOptProblemContainer : public OptProblemContainer<FUNCTIONAL_INTERFACE,FUNCTIONAL,PDE,DD,CONSTRAINTS,
    SPARSITYPATTERN,VECTOR,dopedim,dealdim,FE,HP, DH>
#else
  /**
   * Container class for all nonstationary Optimization problems.
   * This class collects all problem depended data needed to
  ...
  class InstatOptProblemContainer : public OptProblemContainer<FUNCTIONAL_INTERFACE,FUNCTIONAL,PDE,DD,CONSTRAINTS,
    ...
    : OptProblemContainer<FUNCTIONAL_INTERFACE,FUNCTIONAL,PDE,DD,CONSTRAINTS,SPARSITYPATTERN,VECTOR,dopedim,dealdim,FE, HP, DH>(
#else
...
#if DEAL_II_VERSION_GTE(9,3,0)
      OptProblemContainer<FUNCTIONAL_INTERFACE,FUNCTIONAL,PDE,DD,CONSTRAINTS,SPARSITYPATTERN,VECTOR,dopedim,dealdim,FE, HP, DH>::ReInit(algo_type);
#else
      ...
      if (ts_state_problem_ == NULL)
        {
          ...
          SPARSITYPATTERN, VECTOR, dealdim, FE, DH>(OptProblemContainer<FUNCTIONAL_INTERFACE,FUNCTIONAL,PDE,DD,CONSTRAINTS,
                                                    SPARSITYPATTERN,VECTOR,dopedim,dealdim,FE, HP, DH>::GetStateProblem());
        }
      ...
      if (ts_adjoint_problem_ == NULL)
        {
          ...
          PDE, DD, SPARSITYPATTERN, VECTOR, dealdim>,
          SPARSITYPATTERN, VECTOR, dealdim, FE, DH>(OptProblemContainer<FUNCTIONAL_INTERFACE,FUNCTIONAL,PDE,DD,CONSTRAINTS,
                                                    SPARSITYPATTERN,VECTOR,dopedim,dealdim,FE, HP, DH>::GetAdjointProblem());
        }
      ...
      if (ts_tangent_problem_ == NULL)
        {
          ...
          PDE, DD, SPARSITYPATTERN, VECTOR, dealdim>,
          SPARSITYPATTERN, VECTOR, dealdim, FE, DH>(OptProblemContainer<FUNCTIONAL_INTERFACE,FUNCTIONAL,PDE,DD,CONSTRAINTS,
                                                    SPARSITYPATTERN,VECTOR,dopedim,dealdim,FE, HP, DH>::GetTangentProblem());
        }
      ...
      if (ts_adjoint_hessian_problem_ == NULL)
        {
          ...
          PDE, DD, SPARSITYPATTERN, VECTOR, dealdim>,
          SPARSITYPATTERN, VECTOR, dealdim, FE, DH>(OptProblemContainer<FUNCTIONAL_INTERFACE,FUNCTIONAL,PDE,DD,CONSTRAINTS,
                                                    SPARSITYPATTERN,VECTOR,dopedim,dealdim,FE, HP, DH>::GetAdjoint_HessianProblem());
        }
