...
namespace DOpE
{
  ...
  template <template <typename BASE_PROB, typename SPARSITYPATTERN,
            ...
            template <typename BASE_PROB, typename SPARSITYPATTERN, typename VECTOR,
                      ...
                      template <int, int> class DH> class ADJOINTTSPROBLEM, typename PDE,
            typename DD, typename SPARSITYPATTERN, typename VECTOR, int dealdim,
  ...
  public:
    ...
    PDEProblemContainer<PDE, DD, SPARSITYPATTERN, VECTOR, dealdim,
                        FE, DH>, PDE, DD, SPARSITYPATTERN, VECTOR, dealdim>,
                        SPARSITYPATTERN, VECTOR, dealdim, FE, DH> &
                        GetStateProblem ()
    {
      if (ts_state_problem_ == NULL)
