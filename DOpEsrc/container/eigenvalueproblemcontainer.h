...
#ifndef EigenvalueProblemContainer_H_
#define EigenvalueProblemContainer_H_
...
#endif //Deal.ii ver 9.3 ?
  class EigenvalueProblemContainer : public ProblemContainerInternal<PDE>
  {
  public:
    ...
    virtual ~EigenvalueProblemContainer();
      ...
      if (functional_position_.find(F->GetName())
          != functional_position_.end())
        {
          throw DOpEException(
            ...
            "EigenvalueProblemContainer::AddFunctional");
        }
          ...
          if (!found)
            {
              throw DOpEException(
                ...
                + " in aux_functionals_",
                "EigenvalueProblemContainer::SetFunctionalForErrorEstimation");
            }
        }
    }
      ...
      if (it == auxiliary_constraints_.end())
        {
          throw DOpEException("Could not find data" + name,
                              "EigenvalueProblemContainer::GetAuxiliaryConstraint");
        }
      return it->second;
    }
    /*****************************************************************/
            ...
            if (dopedim == dealdim)
            ...
            else
              {
                throw DOpEException("dopedim not implemented",
                                    "EigenvalueProblemContainer::AddAuxiliaryToIntegrator");
              }
          }
      }
      {
  ...
  protected:
      ...
      if (it == values.end())
        {
          throw DOpEException("Did not find " + name,
                              "EigenvalueProblemContainer::GetBlockVector");
        }
      return it->second;
    }
              ...
              std::string name)
    {
      ...
      if (it == values.end())
        {
          throw DOpEException("Did not find " + name,
                              "EigenvalueProblemContainer::GetVector");
        }
      return it->second;
    }
    ...
    if (algo_type_ != algo_type && algo_type_ != "")
      {
        throw DOpEException("Conflicting Algorithms!",
                            "EigenvalueProblemContainer::ReInit");
      }
    else
      {
        ...
        if (dealdim == dopedim)
          {
            ...
            {
              if (this->GetType() =="eigenvaluestate"||this->GetType() == "eigenvalueadjoint"
              ...
              else if (this->GetType() == "eigenvaluegradient"/*||this->GetType() == "eigenvaluehessian"||this->GetType() == "hessian_inverse" || this->GetType() == "global_constraint_gradient"|| this->GetType() == "global_constraint_hessian"*/)
                {
                  GetSpaceTimeHandler()->SetDoFHandlerOrdering(0,1);
                }
              else
                {
                  throw DOpEException("problem_type_ : "+this->GetType()+" not implemented!", "EigenvalueProblemContainer::SetType");
                }
            }
          }
        else
          {
            throw DOpEException("dopedim not implemented", "EigenvalueProblemContainer::SetType");
          }
#else
        //dopedim ==0
        {
...
//                     || this->GetType() == "eigenvaluehessian"
            ...
            else
              {
                throw DOpEException(
                  ...
                  "EigenvalueProblemContainer::SetType");
              }
          }
        }
#endif
    ...
    if ((this->GetType() == "cost_functional") || (this->GetType() == "cost_functional_pre")
    ...
    else
      {
        throw DOpEException("Not implemented",
                            "EigenvalueProblemContainer::ElementFunctional");
      }
  }
                        ...
                        const std::map<std::string, const VECTOR *> &domain_values)
  {
    if ((this->GetType() == "cost_functional")||(this->GetType() == "cost_functional_pre")
      ...
      {
        throw DOpEException("Not implemented",
                            "EigenvalueProblemContainer::PointFunctional");
      }
  }
                        ...
                        const FACEDATACONTAINER &fdc)
  {
    if ((this->GetType() == "cost_functional")||(this->GetType() == "cost_functional_pre")
      ...
      {
        throw DOpEException("Not implemented",
                            "EigenvalueProblemContainer::BoundaryFunctional");
      }
  }
                        ...
                        const FACEDATACONTAINER &fdc)
  {
    if ((this->GetType() == "cost_functional")||(this->GetType() == "cost_functional_pre")
      ...
      {
        throw DOpEException("Not implemented",
                            "EigenvalueProblemContainer::FaceFunctional");
      }
  }
...
// 	       this->GetPDE().ElementEquation_Q(edc, local_vector, scale*interval_length_);
                        ...
                        double /*scale_ico*/)
  {
    ...
    if ( /*|| (this->GetType() == "hessian")||*/ this->GetType() == "eigenvaluegradient")
      ...
      {
        throw DOpEException("Not implemented",
                            "EigenvalueProblemContainer::ElementMatrix");
      }
...
/********************************************************/
                        ...
                        double /*scale_ico*/)
  {
    {
      throw DOpEException("Not implemented",
                          "EigenvalueProblemContainer::FaceEquation");
    }
  }
                        ...
                        double /*scale_ico*/)
  {
    {
      throw DOpEException("Not implemented",
                          "EigenvalueProblemContainer::InterfaceEquation");
    }
  }
                        ...
                        double /*scale*/, double /*scale_ico*/)
  {
    {
      throw DOpEException("Not implemented",
                          "EigenvalueProblemContainer::NewtonInterfaceMatrix");
    }
  }
                        ...
                        double scale, double /*scale_ico*/)
  {
    if ((this->GetType() == "gradient") /*|| (this->GetType() == "hessian")*/)
      ...
      {
        throw DOpEException("Not implemented",
                            "EigenvalueProblemContainer::ElementBoundaryMatrix");
      }
    ...
    if (this->GetType() == "constraints")
    ...
    else
      {
        throw DOpEException("Wrong problem type" + this->GetType(),
                            "EigenvalueProblemContainer::ComputeLocalConstraints");
      }
  }
    ...
    if ((this->GetType() == "eigenvaluegradient")/*|| this->GetType() == "eigenvaluehessian"*/)
    ...
    else
      {
        throw DOpEException("Unknown Type:" + this->GetType(),
                            "EigenvalueProblemContainer::GetDoFType");
      }
  }
    ...
    if (/*(this->GetType() == "global_constraint_gradient")||*/ (this->GetType() == "eigenvaluegradient"))/*|| this->GetType() == "eigenvaluehessian")*/
      {
        ...
        if (dopedim == dealdim)
          ...
          throw DOpEException("Non matching dimensions!","EigenvalueProblemContainer::GetFESystem");
#else
      ...
      {
        throw DOpEException("Unknown Type:" + this->GetType(),
                            "EigenvalueProblemContainer::GetFESystem");
      }
  }
                      ...
                      SPARSITYPATTERN, VECTOR, dopedim, dealdim, FE, DH>::GetFaceUpdateFlags() const
  {
    ...
    if (this->GetType().find("aux_functional") != std::string::npos)
    ...
    else
      {
        ...
        if ( /* this->GetType() == "eigenvaluehessian"||*/ this->GetType() == "eigenvaluegradient")
          {
...
//              adjoint_dirichlet_values_[i]->SetTime(time);
    ...
    if ( this->GetType() == "eigenvaluegradient"/* || this->GetType() == "eigenvaluehessian"*/)
      {
        ...
        throw DOpEException("Wrong dimension",
                            "EigenvalueProblemContainer::ComputeSparsityPattern");
#endif
      }
    else
      {
    ...
    if (auxiliary_state_.find(name) != auxiliary_state_.end())
      {
        throw DOpEException(
          "Adding multiple Data with name " + name + " is prohibited!",
          "EigenvalueProblemContainer::AddAuxiliaryState");
      }
    ...
    if (auxiliary_constraints_.find(name) != auxiliary_constraints_.end())
      {
        throw DOpEException(
          "Adding multiple Data with name " + name + " is prohibited!",
          "EigenvalueProblemContainer::AddAuxiliaryConstraint");
      }
    ...
    if (it == auxiliary_controls_.end())
      {
        throw DOpEException("Could not find Data with name " + name,
                            "EigenvalueProblemContainer::GetAuxiliaryControl");
      }
    return it->second;
  }
                        ...
                        std::string name) const
  {
    ...
    if (it == auxiliary_state_.end())
      {
        throw DOpEException("Could not find Data with name " + name,
                            "EigenvalueProblemContainer::GetAuxiliaryState");
      }
    return it->second;
  }
    ...
    if (it == auxiliary_controls_.end())
      {
        throw DOpEException(
          ...
          "EigenvalueProblemContainer::DeleteAuxiliaryControl");
      }
    ...
    if (it == auxiliary_state_.end())
      {
        throw DOpEException(
          "Deleting Data " + name + " is impossible! Data not found",
          "EigenvalueProblemContainer::DeleteAuxiliaryState");
      }
    ...
    if (it == auxiliary_constraints_.end())
      {
        throw DOpEException(
          "Deleting Data " + name + " is impossible! Data not found",
          "EigenvalueProblemContainer::DeleteAuxiliaryConstraint");
      }
...
//        else if (this->GetType() == "eigenvaluehessian")
//          {
...
//          }
          ...
          {
            throw DOpEException("Unknown Type: '" + this->GetType() + "'!",
                                "EigenvalueProblemContainer::HasFaces");
          }
      }
  }
...
//      }
      ...
      {
        throw DOpEException("Unknown Type: '" + this->GetType() + "'!",
                            "EigenvalueProblemContainer::HasPoints");
      }
  }
//    }
                      ...
                      SPARSITYPATTERN, VECTOR, dopedim, dealdim, FE, DH>::HasInterfaces() const
  {
	...
	else if (this->GetType() == "error_evaluation" )
	{
	  return true;//Always true for jumps over edges
          ...
          {
            throw DOpEException("Unknown Type: '" + this->GetType() + "'!",
                                "EigenvalueProblemContainer::HasInterfaces");
          }
      }
  }
  /******************************************************/
    ...
    if (comp != control_dirichlet_colors_.size())
      {
        ...
        throw DOpEException(s.str(),
                            "EigenvalueProblemContainer::SetControlDirichletBoundary");
      }
    ...
    if (comp != dirichlet_colors_.size())
      {
        ...
        throw DOpEException(s.str(),
                            "EigenvalueProblemContainer::SetDirichletBoundary");
      }
...
//        adjoint_dirichlet_values_.push_back(adata);
                      ...
                      SPARSITYPATTERN, VECTOR, dopedim, dealdim, FE, DH>::GetDirichletColors() const
  {
    if /*((this->GetType() == "hessian")||*/ (this->GetType() == "eigenvaluegradient")
      ...
      {
        throw DOpEException("Unknown Type:" + this->GetType(),
                            "EigenvalueProblemContainer::GetDirichletColors");
      }
  }
  /******************************************************/
                      ...
                      SPARSITYPATTERN, VECTOR, dopedim, dealdim, FE, DH>::GetTransposedDirichletColors() const
  {
    if (this->GetType() == "eigenvaluegradient") /*|| (this->GetType() == "hessian")*/
      ...
      {
        throw DOpEException("Unknown Type:" + this->GetType(),
                            "EigenvalueProblemContainer::GetTransposedDirichletColors");
      }
  }
        ...
        if (comp == control_dirichlet_colors_.size())
          {
            ...
            throw DOpEException(s.str(),
                                "EigenvalueProblemContainer::GetDirichletCompMask");
          }
                        ...
                        unsigned int color) const
  {
    if (this->GetType() == "eigenvaluegradient") /*|| (this->GetType() == "hessian")*/
      ...
      {
        throw DOpEException("Unknown Type:" + this->GetType(),
                            "EigenvalueProblemContainer::GetTransposedDirichletCompMask");
      }
  }
        ...
        if (col == control_dirichlet_colors_.size())
          {
            ...
            s << "ControlDirichletColor" << color << " has not been found !";
            throw DOpEException(s.str(),
                                "EigenvalueProblemContainer::GetDirichletValues");
          }
      }
    else
      {
        ...
        if (col == control_transposed_dirichlet_colors_.size())
          {
            ...
            s << "TransposedControlDirichletColor" << color
              << " has not been found !";
            throw DOpEException(s.str(),
                                "EigenvalueProblemContainer::GetTransposedDirichletValues");
          }
      }
    else
      {
                      ...
                      SPARSITYPATTERN, VECTOR, dopedim, dealdim, FE, DH>::GetBoundaryEquationColors() const
  {
    if (this->GetType() == "eigenvaluegradient")/* || (this->GetType() == "hessian") || (this->GetType() == "eigenvaluehessian"))
      ...
      {
        throw DOpEException("Unknown Type:" + this->GetType(),
                            "EigenvalueProblemContainer::GetBoundaryEquationColors");
      }
  }
      ...
      if (comp != control_boundary_equation_colors_.size())
        {
          ...
          throw DOpEException(s.str(),
                              "EigenvalueProblemContainer::SetControlBoundaryEquationColors");
        }
      ...
      if (comp != state_boundary_equation_colors_.size())
        {
          ...
          s << "Boundary Equation Color" << color
            << " has multiple occurences !";
          throw DOpEException(s.str(),
                              "EigenvalueProblemContainer::SetBoundaryEquationColors");
        }
                      ...
                      SPARSITYPATTERN, VECTOR, dopedim, dealdim, FE, DH>::GetBoundaryFunctionalColors() const
  {
    if (this->GetType() == "cost_functional"
      ...
      {
        throw DOpEException("Unknown Type:" + this->GetType(),
                            "EigenvalueProblemContainer::GetBoundaryFunctionalColors");
      }
  }
      ...
      if (comp != boundary_functional_colors_.size())
        {
          ...
          s << "Boundary Functional Color" << color
            << " has multiple occurences !";
          throw DOpEException(s.str(),
                              "EigenvalueProblemContainer::SetBoundaryFunctionalColors");
        }
                      ...
                      SPARSITYPATTERN, VECTOR, dopedim, dealdim, FE, DH>::GetNBlocks() const
  {
    if ((this->GetType() == "eigenvaluestate")/*||(this->GetType() == "adjoint_for_ee")*/
      ...
      {
        throw DOpEException("Unknown Type:" + this->GetType(),
                            "EigenvalueProblemContainer::GetNBlocks");
      }
  }
                      ...
                      SPARSITYPATTERN, VECTOR, dopedim, dealdim, FE, DH>::GetDoFsPerBlock() const
  {
    if ((this->GetType() == "eigenvaluestate")
      ...
      {
        throw DOpEException("Unknown Type:" + this->GetType(),
                            "EigenvalueProblemContainer::GetDoFsPerBlock");
      }
  }
                      ...
                      SPARSITYPATTERN, VECTOR, dopedim, dealdim, FE, DH>::GetDoFConstraints() const
  {
    if (this->GetType() == "eigenvaluegradient")/*|| (this->GetType() == "eigenvaluehessian")*/
      ...
      {
        throw DOpEException("Unknown Type:" + this->GetType(),
                            "EigenvalueProblemContainer::GetDoFConstraints");
      }
  }
#else
  const dealii::ConstraintMatrix &
                      ...
                      SPARSITYPATTERN, VECTOR, dopedim, dealdim, FE, DH>::NeedTimeFunctional() const
  {
    if ((this->GetType() == "cost_functional")||(this->GetType() == "cost_functional_pre")
      ...
      throw DOpEException("Not implemented",
                          "EigenvalueProblemContainer::NeedTimeFunctional");
  }
