...
namespace DOpE
{
  namespace fdcinternal
  {
    ...
    {
    public:
      FaceDataContainerInternal (const std::map<std::string,
    ...
    /**********************************************************************/
    template <typename VECTOR, int dim>
    FaceDataContainerInternal<VECTOR, dim>::FaceDataContainerInternal (const std::map<
        std::string,
        const dealii::Vector<
        double>*> &param_values,
        const std::map<
    ...
    template <typename VECTOR, int dim>
    void
    FaceDataContainerInternal<VECTOR, dim>::GetFaceValuesState (std::string name,
                                                                std::vector<
                                                                double> &values) const
    {
    ...
    template <typename VECTOR, int dim>
    void
    FaceDataContainerInternal<VECTOR, dim>::GetFaceValuesControl (std::string name,
        std::vector<
        double> &values) const
    {
    ...
    template <int targetdim>
    void
    FaceDataContainerInternal<VECTOR, dim>::GetFaceGradsState (std::string name,
                                                               std::vector<
                                                               dealii::Tensor<
                                                               1,
    ...
    template <int targetdim>
    void
    FaceDataContainerInternal<VECTOR, dim>::GetFaceGradsControl (std::string name,
        std::vector<
        dealii::Tensor<
        1,
        targetdim> > &values) const
    ...
    template <typename VECTOR, int dim>
    void
    FaceDataContainerInternal<VECTOR, dim>::GetNbrFaceValuesState (std::string name,
        std::vector<
        double> &values) const
    {
    ...
    template <typename VECTOR, int dim>
    void
    FaceDataContainerInternal<VECTOR, dim>::GetNbrFaceValuesControl (std::string name,
        std::vector<
        double> &values) const
    {
    ...
    template <int targetdim>
    void
    FaceDataContainerInternal<VECTOR, dim>::GetNbrFaceGradsState (std::string name,
        std::vector<
        Tensor<
        1,
        targetdim> > &values) const
    ...
    template <int targetdim>
    void
    FaceDataContainerInternal<VECTOR, dim>::GetNbrFaceGradsControl (std::string name,
        std::vector<
        Tensor<
        1,
        targetdim> > &values) const
    ...
    template <typename VECTOR, int dim>
    void
    FaceDataContainerInternal<VECTOR, dim>::GetValues (const dealii::FEFaceValuesBase<
                                                       dim> &fe_values,
                                                       std::string name,
                                                       std::vector<double> &values) const
    {
    ...
    template <int targetdim>
    void
    FaceDataContainerInternal<VECTOR, dim>::GetGrads (const dealii::FEFaceValuesBase<
                                                      dim> &fe_values,
                                                      std::string name,
                                                      std::vector<
                                                      dealii::Tensor<1,
