...
namespace DOpE
{
  ...
  public:
     ...
     */
    inline void
    SetSubsection (const std::string subsection);
    /**
     ...
     */
    inline double
    get_double (const std::string &entry_name);
    /**
     * This is a wrapper to the corresponding dealii::ParameterHandler routine.
     * But the previously subsection is set to the last value set by SetSubsection is used for the declaration.
     */
    inline int
    get_integer (const std::string &entry_name);
    /**
     * This is a wrapper to the corresponding dealii::ParameterHandler routine.
     * But the previously subsection is set to the last value set by SetSubsection is used for the declaration.
     */
    inline std::string
    get_string (const std::string &entry_name);
    /**
     * This is a wrapper to the corresponding dealii::ParameterHandler routine.
     * But the previously subsection is set to the last value set by SetSubsection is used for the declaration.
     */
    inline bool
    get_bool (const std::string &entry_name);
  ...
  void
  ParameterReader::SetSubsection (const std::string subsection)
  {
    subsection_ = subsection;
  }

  void
  ParameterReader::declare_entry (const std::string &entry,
                                  const std::string &default_value,
                                  const Patterns::PatternBase &pattern,
  ...
  double
  ParameterReader::get_double (const std::string &entry_name)
  {
    double ret;
    prm.enter_subsection (subsection_);
    {
  ...
  int
  ParameterReader::get_integer (const std::string &entry_name)
  {
    int ret;
    prm.enter_subsection (subsection_);
    {
  ...
  std::string
  ParameterReader::get_string (const std::string &entry_name)
  {
    std::string ret;
    prm.enter_subsection (subsection_);
    {
  ...
  bool
  ParameterReader::get_bool (const std::string &entry_name)
  {
    bool ret;
    prm.enter_subsection (subsection_);
    {
