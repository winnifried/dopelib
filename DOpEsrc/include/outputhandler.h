...
/////////////////////////////
  ...
  public:
    ...
    DOpEOutputHandler (ReducedProblemInterface_Base<VECTOR> *SI,
     ...
     */
    void
    WriteElementwise (const Vector<double> &q,
                      std::string name,
                      std::string dof_type);
     ...
     */
    void
    Write (const ControlVector<VECTOR> &q,
           std::string name,
           std::string dof_type);
    //    /**
     ...
     */
    void
    Write (const std::vector<double> &q,
           std::string name,
           std::string dof_type);
    /**
     ...
     */
    void
    SetIterationNumber (unsigned int iteration,
                        std::string type);
    /**
     ...
     */
    std::string
    ConstructOutputName (std::string name,
                         std::string dof_type);
     ...
     */
    void
    StartSaveCTypeOutputToLog ();
    /**
     * Disables the redirect of std::cout
     */
    void
    StopSaveCTypeOutputToLog ();
  ...
  protected:
     ...
     */
    bool
    AllowIteration (std::string name);
    /**
     ...
     */
    void
    ParseString (const std::string tmp,
  ...
  private:
    ...
    int printlevel_;
    std::string results_basedir_, results_outdir_, ending_, control_ending_,
        logfile_;
