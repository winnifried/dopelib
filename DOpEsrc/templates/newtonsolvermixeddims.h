...
namespace DOpE
{
  ...
  {
  public:
    NewtonSolverMixedDimensions (INTEGRATOR &integrator,
  ...
  template <typename INTEGRATOR, typename LINEARSOLVER, typename VECTOR>
  void
  NewtonSolverMixedDimensions<INTEGRATOR, LINEARSOLVER, VECTOR>::declare_params (ParameterReader &param_reader)
  {
  ...
  template <typename INTEGRATOR, typename LINEARSOLVER, typename VECTOR>
  NewtonSolverMixedDimensions<INTEGRATOR, LINEARSOLVER, VECTOR>::NewtonSolverMixedDimensions (INTEGRATOR &integrator,
      ParameterReader &param_reader)
  ...
  template <typename INTEGRATOR, typename LINEARSOLVER, typename VECTOR>
  NewtonSolverMixedDimensions<INTEGRATOR, LINEARSOLVER, VECTOR>::~NewtonSolverMixedDimensions ()
  {
  }
  ...
  template <typename PROBLEM>
  void
  NewtonSolverMixedDimensions<INTEGRATOR, LINEARSOLVER, VECTOR>::ReInit (PROBLEM &pde)
  {
  ...
  template <typename PROBLEM>
  bool
  NewtonSolverMixedDimensions<INTEGRATOR, LINEARSOLVER, VECTOR>::NonlinearSolve (PROBLEM &pde,
      VECTOR &solution,
  ...
  template <typename INTEGRATOR, typename LINEARSOLVER, typename VECTOR>
  INTEGRATOR &
  NewtonSolverMixedDimensions<INTEGRATOR, LINEARSOLVER, VECTOR>::GetIntegrator ()
  {
    return integrator_;
  }
