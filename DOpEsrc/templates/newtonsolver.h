...
namespace DOpE
{
  ...
  {
  public:
    NewtonSolver (INTEGRATOR &integrator,
  ...
  template <typename INTEGRATOR, typename LINEARSOLVER, typename VECTOR>
  void
  NewtonSolver<INTEGRATOR, LINEARSOLVER, VECTOR>::declare_params (ParameterReader &param_reader)
  {
  ...
  template <typename INTEGRATOR, typename LINEARSOLVER, typename VECTOR>
  NewtonSolver<INTEGRATOR, LINEARSOLVER, VECTOR>::NewtonSolver (INTEGRATOR &integrator,
      ParameterReader &param_reader)
  ...
  template <typename PROBLEM>
  void
  NewtonSolver<INTEGRATOR, LINEARSOLVER, VECTOR>::ReInit (PROBLEM &pde)
  {
  ...
  template <typename PROBLEM>
  bool
  NewtonSolver<INTEGRATOR, LINEARSOLVER, VECTOR>::NonlinearSolve (PROBLEM &pde,
      VECTOR &solution,
