...
namespace DOpE
{
  ...
  template <typename FDC>
  void
  InitialProblem<PDE, VECTOR, dim>::FaceEquation (const FDC &fdc,
                                                  dealii::Vector<double> &local_vector,
                                                  double scale,
                                                  double scale_ico)
  {
  ...
  template <typename FDC>
  void
  InitialProblem<PDE, VECTOR, dim>::InterfaceEquation (const FDC &fdc,
                                                       dealii::Vector<double> &local_vector,
                                                       double scale,
                                                       double scale_ico)
  {
  ...
  template <typename FDC>
  void
  InitialProblem<PDE, VECTOR, dim>::BoundaryEquation (const FDC &fdc,
                                                      dealii::Vector<double> &local_vector,
                                                      double scale,
                                                      double scale_ico)
  {
  ...
  template <typename PDE, typename VECTOR, int dim>
  void
  InitialProblem<PDE, VECTOR, dim>::PointRhs (const std::map<std::string,
                                              const dealii::Vector<double>*> &param_values,
                                              const std::map<std::string,
  ...
  template <typename FDC>
  void
  InitialProblem<PDE, VECTOR, dim>::FaceRhs (const FDC & /*fdc*/,
                                             dealii::Vector<double> &/*local_vector*/,
                                             double /*scale*/)
  {
  }
  ...
  template <typename FDC>
  void
  InitialProblem<PDE, VECTOR, dim>::BoundaryRhs (const FDC & /*fdc*/,
                                                 dealii::Vector<double> &/*local_vector*/,
                                                 double /*scale*/)
  {
  }
  ...
  template <typename FDC>
  void
  InitialProblem<PDE, VECTOR, dim>::InterfaceMatrix (const FDC &fdc,
                                                     FullMatrix<double> &local_matrix,
                                                     double scale,
                                                     double scale_ico)
  {
  ...
  template <typename FDC>
  void
  InitialProblem<PDE, VECTOR, dim>::BoundaryMatrix (const FDC &fdc,
                                                    FullMatrix<double> &local_matrix,
                                                    double scale,
                                                    double scale_ico)
  {
  ...
  template <typename SPARSITYPATTERN>
  void
  InitialProblem<PDE, VECTOR, dim>::ComputeSparsityPattern (SPARSITYPATTERN &sparsity) const
  {
  ...
  InitialProblem<PDE, VECTOR, dim>::GetDirichletCompMask (unsigned int color) const
  {
  ...
  template <typename ELEMENTITERATOR>
  bool
  InitialProblem<PDE, VECTOR, dim>::AtInterface (ELEMENTITERATOR &element,
                                                 unsigned int face) const
  {
