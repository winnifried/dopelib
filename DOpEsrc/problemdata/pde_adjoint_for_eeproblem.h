...
namespace DOpE
{
    ...
    dim>::ElementTimeEquation(const EDC& /*edc*/,
			      dealii::Vector<double> &/*local_vector*/, double /*scale*/)
      {
          throw DOpEException("Not implemented",
              "PDE_Adjoint_For_EEProblem::ElementTimeEquation");
      }
  ...
  template<typename OPTPROBLEM, typename PDE, typename DD,
    ...
    dim>::ElementTimeEquationExplicit(const EDC& /*edc*/,
      ...
      {
          throw DOpEException("Not implemented",
              "PDE_Adjoint_For_EEProblem::ElementTimeEquationExplicit");
      }
  ...
  template<typename OPTPROBLEM, typename PDE, typename DD,
	...
	if (opt_problem_.aux_functionals_[opt_problem_.functional_for_ee_num_]->GetType().find("domain")
	    != std::string::npos)
  ...
  template<typename OPTPROBLEM, typename PDE, typename DD,
    ...
    {
        //values of the derivative of the functional for error estimation
      if (opt_problem_.aux_functionals_[opt_problem_.functional_for_ee_num_]->GetType().find("point")
            != std::string::npos)
  ...
  template<typename OPTPROBLEM, typename PDE, typename DD,
    ...
    dim>::ElementTimeMatrix(const EDC& /*edc*/,
	  ...
	  {
	    throw DOpEException("Not implemented",
				"PDE_Adjoint_For_EEProblem::ElementTimeMatrix");
	  }
