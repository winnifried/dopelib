...
#ifndef ADJOINT_DIRICHLET_DATA_H_
#define ADJOINT_DIRICHLET_DATA_H_
...
namespace DOpE
{
  ...
  /**
   * This class is used to extract the Dirichlet Data for the Adjoint Problem
   *
  ...
  class AdjointDirichletData : public DOpEWrapper::Function<dealdim>
  {
  public:
    AdjointDirichletData(const DD &data) : DOpEWrapper::Function<dealdim>(data.n_components(), data.InitialTime()), dirichlet_data_(data)
    {
      param_values_ = NULL;
      domain_values_ = NULL;
      color_ = 0;
