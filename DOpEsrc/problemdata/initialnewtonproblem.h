...
namespace DOpE
{
  ...
  template <typename FDC>
  void
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::FaceEquation (const FDC & /*fdc*/,
      dealii::Vector<
      double> &/*local_vector*/,
      double /*scale*/,
      double /*scale_ico*/)
  ...
  template <typename FDC>
  void
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::InterfaceEquation (const FDC & /*fdc*/,
      dealii::Vector<
      double> &/*local_vector*/,
      double /*scale*/,
      double /*scale_ico*/)
  ...
  template <typename FDC>
  void
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::BoundaryEquation (const FDC & /*fdc*/,
      dealii::Vector<
      double> &/*local_vector*/,
      double /*scale*/,
      double /*scale_ico*/)
  ...
  template <typename OPTPROBEM, typename PDE, typename VECTOR, int dim>
  void
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::PointRhs (const std::map<
      std::string,
      const dealii::Vector<
      double>*> &/*param_values*/,
      const std::map<
  ...
  template <typename FDC>
  void
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::FaceRhs (const FDC & /*fdc*/,
                                                              dealii::Vector<
                                                              double> &/*local_vector*/,
                                                              double /*scale*/)
  {
  ...
  template <typename FDC>
  void
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::BoundaryRhs (const FDC & /*fdc*/,
      dealii::Vector<
      double> &/*local_vector*/,
      double /*scale*/)
  {
  ...
  template <typename FDC>
  void
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::InterfaceMatrix (const FDC & /*fdc*/,
      FullMatrix<
      double> &/*local_matrix*/,
      double /*scale*/,
      double /*scale_ico*/)
  ...
  template <typename FDC>
  void
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::BoundaryMatrix (const FDC & /*fdc*/,
      FullMatrix<
      double> &/*local_matrix*/,
      double /*scale*/,
      double /*scale_ico*/)
  ...
  template <typename SPARSITYPATTERN>
  void
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::ComputeSparsityPattern (SPARSITYPATTERN &sparsity) const
  {
  ...
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::GetDirichletCompMask (unsigned int color) const
  {
  ...
  template <typename ELEMENTITERATOR>
  bool
  InitialNewtonProblem<OPTPROBEM, PDE, VECTOR, dim>::AtInterface (ELEMENTITERATOR &element,
      unsigned int face) const
  {
