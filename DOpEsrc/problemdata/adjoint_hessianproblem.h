...
namespace DOpE
{
  ...
  template<typename OPTPROBLEM, typename PDE, typename DD,
	...
	return false;
      ...
      InitialNewtonProblem<OPTPROBLEM,Adjoint_HessianProblem<OPTPROBLEM,PDE,DD,SPARSITYPATTERN,VECTOR,dim>, VECTOR, dim>&
	...
	if(NeedInitialState())
	{
	  if ( initial_newton_problem_ == NULL)
	  {
	    initial_newton_problem_ = new InitialNewtonProblem<OPTPROBLEM,Adjoint_HessianProblem<OPTPROBLEM,PDE,DD,SPARSITYPATTERN,VECTOR,dim>, VECTOR, dim>
	  (*this);
	  }
	...
	{
	  throw DOpEException("GetNewtonInitialProblem has no meaning in case NeedInitialState() == false","Adjoint_HessianProblem::GetNewtonInitialProblem");
	}
      }
    ...
    private:
      ...
      InitialNewtonProblem<OPTPROBLEM,Adjoint_HessianProblem<OPTPROBLEM,PDE,DD,SPARSITYPATTERN,VECTOR,dim>, VECTOR, dim> * initial_newton_problem_;
