...
namespace DOpE
{
  ...
  class TransposedHessianDirichletData : public TransposedDirichletDataInterface<
    dealdim>
  {
  public:
    TransposedHessianDirichletData (const DD &data)
      : TransposedDirichletDataInterface<dealdim> (),
    ...
    {
      dirichlet_data_.Data_QT (param_values_, domain_values_, color_, p,
                               component, dof_number, local_vector);
      dirichlet_data_.Data_QQT (param_values_, domain_values_, color_, p,
                                component, dof_number, local_vector);
    }
