...
// !!! Daniel !!!
template class DOpE::FunctionalInterface<DOpE::ElementDataContainer,
                                         DOpE::FaceDataContainer, dealii::DoFHandler, dealii::TrilinosWrappers::MPI::Vector,
                                         dope_dimension, deal_II_dimension>;

template class DOpE::FunctionalInterface<DOpE::ElementDataContainer,
                                         DOpE::FaceDataContainer, dealii::DoFHandler, dealii::TrilinosWrappers::MPI::BlockVector,
                                         dope_dimension, deal_II_dimension>;
...
template class DOpE::FunctionalInterface<DOpE::Multimesh_ElementDataContainer,
                                         DOpE::Multimesh_FaceDataContainer, dealii::DoFHandler,
                                         dealii::TrilinosWrappers::MPI::BlockVector, dope_dimension, deal_II_dimension>;
...
// !!! Daniel !!!
template class DOpE::FunctionalInterface<DOpE::ElementDataContainer,
                                         DOpE::FaceDataContainer, dealii::hp::DoFHandler, dealii::TrilinosWrappers::MPI::Vector,
                                         dope_dimension, deal_II_dimension>;
