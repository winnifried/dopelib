...
namespace DOpE
{
  ...
  template<template<typename DOFHANDLER, typename VECTOR, int dealdim> class CDC, template<typename DOFHANDLER, typename VECTOR, int dealdim> class FDC, typename DOFHANDLER, typename VECTOR, int dopedim, int dealdim>
  void
  PDEInterface<CDC, FDC, DOFHANDLER, VECTOR, dopedim, dealdim>::StrongCellEquation(
      const CDC<DOFHANDLER, VECTOR, dealdim>& /*cdc*/,
      dealii::Vector<double> &/*local_cell_vector*/, double /*scale*/, double /*scale_ico*/)
      {
        throw DOpEException("Not Implemented", "PDEInterface::StrongCellEquation");
      }
  ...
  template<template<typename DOFHANDLER, typename VECTOR, int dealdim> class CDC, template<typename DOFHANDLER, typename VECTOR, int dealdim> class FDC, typename DOFHANDLER, typename VECTOR, int dopedim, int dealdim>
  void
  PDEInterface<CDC, FDC, DOFHANDLER, VECTOR, dopedim, dealdim>::StrongCellEquation_U(
      const CDC<DOFHANDLER, VECTOR, dealdim>&,
      dealii::Vector<double> &local_cell_vector __attribute__((unused)), double scale __attribute__((unused)))
      {
        throw DOpEException("Not Implemented", "PDEInterface::StrongCellEquation_U");
      }
  ...
  template<template<typename DOFHANDLER, typename VECTOR, int dealdim> class CDC, template<typename DOFHANDLER, typename VECTOR, int dealdim> class FDC, typename DOFHANDLER, typename VECTOR, int dopedim, int dealdim>
  void
  PDEInterface<CDC, FDC, DOFHANDLER, VECTOR, dopedim, dealdim>::StrongFaceEquation(
      const FDC<DOFHANDLER, VECTOR, dealdim>&,
      dealii::Vector<double> &local_cell_vector __attribute__((unused)), double scale __attribute__((unused)))
      {
        throw DOpEException("Not Implemented", "PDEInterface::StrongFaceEquation");
      }
  ...
  template<template<typename DOFHANDLER, typename VECTOR, int dealdim> class CDC, template<typename DOFHANDLER, typename VECTOR, int dealdim> class FDC, typename DOFHANDLER, typename VECTOR, int dopedim, int dealdim>
  void
  PDEInterface<CDC, FDC, DOFHANDLER, VECTOR, dopedim, dealdim>::StrongFaceEquation_U(
      const FDC<DOFHANDLER, VECTOR, dealdim>&,
      dealii::Vector<double> &local_cell_vector __attribute__((unused)), double scale __attribute__((unused)))
      {
        throw DOpEException("Not Implemented", "PDEInterface::StrongFaceEquation_U");
      }
  ...
  PDEInterface<CDC, FDC, DOFHANDLER, VECTOR, dopedim, dealdim>::InterfaceEquation_U(
      ...
      dealii::Vector<double> &local_cell_vector __attribute__((unused)), double scale __attribute__((unused)))
      {
        throw DOpEException("Not Implemented", "PDEInterface::InterfaceEquation_U");
      }
  ...
  template<template<typename DOFHANDLER, typename VECTOR, int dealdim> class CDC, template<typename DOFHANDLER, typename VECTOR, int dealdim> class FDC, typename DOFHANDLER, typename VECTOR, int dopedim, int dealdim>
  void
  PDEInterface<CDC, FDC, DOFHANDLER, VECTOR, dopedim, dealdim>::StrongBoundaryEquation(
      const FDC<DOFHANDLER, VECTOR, dealdim>&,
      dealii::Vector<double> &local_cell_vector __attribute__((unused)), double scale __attribute__((unused)))
      {
        throw DOpEException("Not Implemented", "PDEInterface::BoundaryEquation");
  ...
  PDEInterface<CDC, FDC, DOFHANDLER, VECTOR, dopedim, dealdim>::BoundaryEquation_U(
      ...
      dealii::Vector<double> &local_cell_vector __attribute__((unused)), double scale __attribute__((unused)))
      {
        throw DOpEException("Not Implemented", "PDEInterface::BoundaryEquation_U");
      }
  ...
  template<template<typename DOFHANDLER, typename VECTOR, int dealdim> class CDC, template<typename DOFHANDLER, typename VECTOR, int dealdim> class FDC, typename DOFHANDLER, typename VECTOR, int dopedim, int dealdim>
  void
  PDEInterface<CDC, FDC, DOFHANDLER, VECTOR, dopedim, dealdim>::StrongBoundaryEquation_U(
      const FDC<DOFHANDLER, VECTOR, dealdim>&,
      dealii::Vector<double> &local_cell_vector __attribute__((unused)), double scale __attribute__((unused)))
      {
        throw DOpEException("Not Implemented", "PDEInterface::BoundaryEquation_U");
  ...
  PDEInterface<CDC, FDC, DOFHANDLER, VECTOR, dopedim, dealdim>::BoundaryEquation_Q(
      ...
      dealii::Vector<double> &local_cell_vector __attribute__((unused)), double scale __attribute__((unused)))
      {
        throw DOpEException("Not Implemented", "PDEInterface::BoundaryEquation_Q");
      }
