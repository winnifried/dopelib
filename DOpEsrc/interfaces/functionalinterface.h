 ...
 */
template<template<typename DOFHANDLER, typename VECTOR, int dealdim> class CDC, template<typename DOFHANDLER, typename VECTOR, int dealdim> class FDC, typename DOFHANDLER, typename VECTOR, int dopedim, int dealdim=dopedim>
class FunctionalInterface
{
  public:
     ...
     */
    virtual double Value(const CDC<DOFHANDLER, VECTOR, dealdim>& cdc);
     ...
     */
    virtual double
        PointValue(const DOpEWrapper::DoFHandler<dopedim, DOFHANDLER> & control_dof_handler,
     ...
     */
    virtual void Value_U(const CDC<DOFHANDLER, VECTOR, dealdim>& cdc,
     ...
     * @param scale                    A factor by which the result is scaled.
     */
    virtual void Value_Q(const CDC<DOFHANDLER, VECTOR, dealdim>& cdc,
                         dealii::Vector<double> &local_cell_vector,
                         double scale);
     ...
     * @param scale                    A factor by which the result is scaled.
     */
    virtual void Value_UU(const CDC<DOFHANDLER, VECTOR, dealdim>& cdc,
                          dealii::Vector<double> &local_cell_vector,
                          double scale);
     ...
     * @param scale                    A factor by which the result is scaled.
     */
    virtual void Value_QU(const CDC<DOFHANDLER, VECTOR, dealdim>& cdc,
                          dealii::Vector<double> &local_cell_vector,
                          double scale);
     ...
     * @param scale                    A factor by which the result is scaled.
     */
    virtual void Value_UQ(const CDC<DOFHANDLER, VECTOR, dealdim>& cdc,
                          dealii::Vector<double> &local_cell_vector,
                          double scale);
     ...
     * @param scale                    A factor by which the result is scaled.
     */
    virtual void Value_QQ(const CDC<DOFHANDLER, VECTOR, dealdim>& cdc,
                          dealii::Vector<double> &local_cell_vector,
                          double scale);
     ...
     */
    virtual double BoundaryValue(const  FDC<DOFHANDLER, VECTOR, dealdim>& fdc);
     ...
     * @param color     The color of the current boundary piece
     */
    virtual void BoundaryValue_U(const  FDC<DOFHANDLER, VECTOR, dealdim>& fdc, dealii::Vector<
     ...
     */
    virtual void AlgebraicGradient_Q(VECTOR& gradient,
				     const std::map<std::string, const dealii::Vector<double>* > &param_values,
				     const std::map<std::string, const VECTOR* > &domain_values);
     ...
     */
    virtual void SetTime(double t __attribute__((unused))) const
    {
    }
