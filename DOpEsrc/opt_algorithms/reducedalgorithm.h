...
namespace DOpE
{
  ...
  public:
     ...
     */
    virtual void
    FirstDifferenceQuotient (double exact,
                             double eps,
     ...
     */
    virtual void
    SecondDifferenceQuotient (double exact,
                              double eps,
                              const ControlVector<VECTOR> &q,
                              const ControlVector<VECTOR> &dq);
  ...
  template <typename PROBLEM, typename VECTOR>
  void
  ReducedAlgorithm<PROBLEM, VECTOR>::declare_params (ParameterReader &param_reader)
  {
  ...
  template <typename PROBLEM, typename VECTOR>
  ReducedAlgorithm<PROBLEM, VECTOR>::ReducedAlgorithm (PROBLEM *OP,
  ...
  template <typename PROBLEM, typename VECTOR>
  void
  ReducedAlgorithm<PROBLEM, VECTOR>::SolveForward (ControlVector<VECTOR> &q)
  {
    q.ReInit ();
  ...
  template <typename PROBLEM, typename VECTOR>
  void
  ReducedAlgorithm<PROBLEM, VECTOR>::FirstDifferenceQuotient (double exact,
                                                              double eps,
                                                              const ControlVector<
                                                              VECTOR> &q,
                                                              const ControlVector<
                                                   ...
                                                   double eps)
  {
    ...
    this->GetReducedProblem ()->ComputeReducedHessianVector (point, dq,
                                                             hessian, hessian_transposed);
  ...
  template <typename PROBLEM, typename VECTOR>
  void
  ReducedAlgorithm<PROBLEM, VECTOR>::SecondDifferenceQuotient (double exact,
      double eps,
      const ControlVector<
      VECTOR> &q,
      const ControlVector<
      VECTOR> &dq)
  {
    ...
    double cost_mid = 0.;
    //Differenzenquotient
    cost_mid = this->GetReducedProblem ()->ComputeReducedCostFunctional (
                 point);
