...
#ifndef REDUCEDGRADIENTDESCENT__ALGORITHM_EIGENVALUEPROBLEMS_H_
#define REDUCEDGRADIENTDESCENT__ALGORITHM_EIGENVALUEPROBLEMS_H_
...
{
  /**
   * @class ReducedGradientDescentAlgorithm_EigenvalueProblems
   *
  ...
  class ReducedGradientDescentAlgorithm_EigenvalueProblems : public ReducedAlgorithm<PROBLEM, VECTOR>
  {
  public:
    /**
  ...
  private:
    unsigned int nonlinear_maxiter_, line_maxiter_, number_of_eigenvalues_;
    double       nonlinear_tol_, nonlinear_global_tol_, lineasearch_rho_, linesearch_c_, eigenvalue_tol_;//, target_eigenvalue_;
  ...
  template <typename PROBLEM, typename VECTOR>
  void ReducedGradientDescentAlgorithm_EigenvalueProblems<PROBLEM, VECTOR>::declare_params(ParameterReader &param_reader)
  {
  ...
  template <typename PROBLEM, typename VECTOR>
  ReducedGradientDescentAlgorithm_EigenvalueProblems<PROBLEM, VECTOR>::ReducedGradientDescentAlgorithm_EigenvalueProblems(PROBLEM *OP,
      ReducedProblemInterface<PROBLEM, VECTOR> *S,
      ParameterReader &param_reader,
    ...
    : ReducedAlgorithm<PROBLEM, VECTOR>(OP,S,param_reader,Except,Output,base_priority)
  {
    ...
    number_of_eigenvalues_ = param_reader.get_integer("number_of_eigenvalues");
//    target_eigenvalue_ = param_reader.get_double("target_eigenvalue");
  ...
  template <typename PROBLEM, typename VECTOR>
  ReducedGradientDescentAlgorithm_EigenvalueProblems<PROBLEM, VECTOR>::~ReducedGradientDescentAlgorithm_EigenvalueProblems()
  {
  ...
  template <typename PROBLEM, typename VECTOR>
  double ReducedGradientDescentAlgorithm_EigenvalueProblems<PROBLEM, VECTOR>::GradientDescentResidual(const ControlVector<VECTOR> &q)
  {
    //Solve j'(q) = 0
  ...
  template <typename PROBLEM, typename VECTOR>
  int ReducedGradientDescentAlgorithm_EigenvalueProblems<PROBLEM, VECTOR>::Solve(ControlVector<VECTOR> &q,double global_tol)
  {
	     q.ReInit();
...
//	     out << "eigenvalue to achieve = " << target_eigenvalue_ << "\n";
	     out << "**************************************************";
...
//	         this->GetReducedProblem()->DeleteUserDomainData("control_counter");
  ...
  template <typename PROBLEM, typename VECTOR>
  int ReducedGradientDescentAlgorithm_EigenvalueProblems<PROBLEM, VECTOR>::ReducedGradientDescentLineSearch(const ControlVector<VECTOR> &dq,
      const ControlVector<VECTOR>  &gradient,
      double &cost,
      ControlVector<VECTOR> &q)
  {
