...
namespace DOpE
{
  namespace Networks
  {
    ...
    public:
      ...
      void
      InitializeFDC (unsigned int pipe,
                     unsigned int n_pipes,
                     unsigned int n_comp,
                     const FACEQUADRATURE &fquad,
      ...
      {
        delete fdc_;
        fdc_ = new Network_FaceDataContainer<DH, VECTOR, dim> (pipe,
                                                               n_pipes, n_comp, fquad, update_flags, sth, element,
      ...
      InitializeFDC (unsigned int pipe,
                     ...
                     bool need_interfaces = false)
      {
        InitializeFDC (pipe, n_pipes, n_comp, GetFaceQuad (),
      ...
      template <typename STH>
      void
      InitializeEDC (unsigned int pipe,
                     ...
                     const dealii::BlockVector<double> *> &domain_values)
      {
        if (edc_ != NULL)
          delete edc_;
        edc_ = new Network_ElementDataContainer<DH, VECTOR, dim> (pipe,
                                                                  quad, update_flags, sth, element, param_values,
                                                                  domain_values);
      }
      ...
      InitializeEDC (unsigned int pipe,
                     ...
                     const dealii::BlockVector<double> *> &domain_values)
      {
        InitializeEDC (pipe, GetQuad (), update_flags, sth, element,
