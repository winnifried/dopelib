...
//        }
    ...
    FEValues (const dealii::FEValues<dim> &fe_values)
      : dealii::FEValues<dim> (fe_values.get_mapping (),
                               fe_values.get_fe (), fe_values.get_quadrature (),
  ...
  {
  public:
    FEFaceValues (const DOpEWrapper::Mapping<dim, dealii::DoFHandler> &mapping,
                  const dealii::FiniteElement<dim, dim> &fe,
...
//        }
  ...
  public:
    ...
    FESubfaceValues (const DOpEWrapper::Mapping<dim, dealii::DoFHandler> &mapping,
                     const dealii::FiniteElement<dim, dim> &fe,
                     const dealii::Quadrature<dim - 1> &quadrature,
                     const dealii::UpdateFlags update_flags)
...
//        }
  ...
  {
  public:
    HpFEValues (const DOpEWrapper::Mapping<dim, dealii::hp::DoFHandler> &mapping_collection,
  ...
  {
  public:
    HpFEFaceValues (const DOpEWrapper::Mapping<dim, dealii::hp::DoFHandler> &mapping_collection,
                    const dealii::hp::FECollection<dim, dim> &fe_collection,
  ...
  public:
    ...
    HpFESubfaceValues (const DOpEWrapper::Mapping<dim,
                       dealii::hp::DoFHandler> &mapping_collection,
                       const dealii::hp::FECollection<dim, dim> &fe_collection,
                       const dealii::hp::QCollection<dim - 1> & q_collection,
                       const dealii::UpdateFlags update_flags)
    ...
    HpFESubfaceValues (const dealii::hp::FECollection<dim, dim> &fe_collection,
                       const dealii::hp::QCollection<dim - 1> & q_collection,
                       const dealii::UpdateFlags update_flags)
