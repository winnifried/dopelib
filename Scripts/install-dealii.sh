...
then
	...
	echo "Unknown deal.ii version "${dealii_version}" must be [git|9.7.0|9.6.2|9.6.1|9.6.0|9.5.2|9.5.1|9.5.0|9.4.2|9.4.1|9.4.0|9.3.3|9.3.2|9.3.1|9.3.0|9.2.0|9.1.1|9.0.1]"
	exit 1;
    fi
fi
